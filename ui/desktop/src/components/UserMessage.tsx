    ...
    <div className="w-full opacity-0 animate-[appear_150ms_ease-in_forwards]">
      <div className="flex flex-col group">
        {isEditing ? (
          ...
          <div className="w-full max-w-[720px] mx-auto bg-background-light dark:bg-background-dark text-text-prominent rounded-xl border border-border-subtle shadow-lg py-4 px-4 my-2">
            <textarea
              ref={textareaRef}
              value={editContent}
          ...
          <div className="message flex justify-center w-full">
            <div className="flex-col max-w-[720px] w-full flex items-end">
              <div className="flex flex-col group w-fit">
                <div className="flex bg-gray-900 text-white rounded-3xl py-2.5 px-4">
                  <div ref={contentRef}>
                    <MarkdownContent
                      content={displayText}
                ...
                <div className="relative h-2 flex justify-end text-right">
                  <div className="absolute w-40 font-mono right-0 text-xs text-text-muted pt-1 opacity-0">
                    {timestamp}
                  </div>
                  <div className="absolute right-0 pt-1 flex items-center gap-2 opacity-0">
                    <button
                      ...
                      className="flex items-center gap-1 text-xs text-text-subtle hover:cursor-pointer hover:text-text-prominent focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-opacity-50 rounded"
