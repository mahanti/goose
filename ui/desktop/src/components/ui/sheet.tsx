...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Overlay
    ...
    className={cn(
      'data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 fixed inset-0 z-50 bg-black/50 animate-swift-spring-all',
      className
    )}
    {...props}
  />
  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          'bg-background-default data-[state=open]:animate-in data-[state=closed]:animate-out fixed z-50 flex flex-col gap-4 animate-swift-spring-all shadow-lg',
          side === 'right' &&
