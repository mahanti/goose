    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-h-[90vh] overflow-y-auto">
        <DialogHeaderWithActions
          actions={
            <div className="flex items-center gap-2">
              <Button type="button" onClick={handleClose} variant="outline" disabled={creating}>
                Cancel
              </Button>
        ...
        >
          ...
          <DialogDescription>
            Create a new recipe configuration for automating tasks and workflows.
          </DialogDescription>
        </DialogHeaderWithActions>
...
export function CreateRecipeButton({ onClick }: { onClick: () => void }) {
  return (
    <Button onClick={onClick} variant="primary" size="sm" className="flex items-center gap-2">
      Create recipe
    </Button>
  );
}
