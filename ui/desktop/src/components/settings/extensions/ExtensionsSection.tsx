...
import { getFriendlyTitle } from './subcomponents/ExtensionList';
...
export default function ExtensionsSection({
  ...
  const extensions = useMemo(() => {
    ...
    let processedExtensions = [...extensionsList]
      .sort((a, b) => {
    ...
    if (searchQuery.trim()) {
      ...
      processedExtensions = processedExtensions.filter(ext => {
        ...
        return friendlyTitle.includes(query) || 
               name.includes(query) || 
  ...
  }, [extensionsList, disableConfiguration, selectedExtensions, searchQuery]);
